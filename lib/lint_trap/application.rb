...
require 'lint_trap/configuration_loader'
require 'lint_trap/configuration_resolver'
...
module LintTrap
  ...
  class Application
    ...
    # LintTrap application easy. It defines a class instance variable which is
    ...
    # @return [LintTrap::Configuration] Base configuration which all other
    ...
    def create_command(command)
      ...
      require 'lint_trap/command/base'
      begin
        require "lint_trap/command/#{Utils.snake_case(command)}"
